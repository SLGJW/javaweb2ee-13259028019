...
<body>
<h1>学生列表</h1>
<a href="/stu61/create.html">增添学生</a>&nbsp;&nbsp;
<a href="/stu61/retrieve.html">查找学生</a><br>
<%
...
<table width="400px" cellspacing="0px" border="1px">
    ...
    <tr>
        ...
        <%}%>
        <td>
            <form action="/stu61/DeleteServlet" method="get" onsubmit="return deletes(this.id)">
                <input type="hidden" id="d" value="<%=obj[0]%>" name="sid">
                <input type="submit" value="删除">
            </form>
        </td>
        <td>
            <form action="/stu61/update.jsp" method="get" onsubmit="return updates(this.id)">
...
<h3>点击此处<a href="/stu61/logoutServlet">【注销管理员登录】</a></h3>
</body>
<%} else { %>
<%
